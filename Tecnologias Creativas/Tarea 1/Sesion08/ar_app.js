...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-pattern1.patt',
    });
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('03.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('03.obj', function (group) {
                RhinoMesh = group.children[0];
                RhinoMesh.material.side = THREE.DoubleSide;
                RhinoMesh.scale.set(0.05, 0.05, 0.05);
                RhinoMesh.castShadow = true;
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('04.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('04.obj', function (group) {
                RhinoMesh = group.children[0];
                RhinoMesh.material.side = THREE.DoubleSide;
                RhinoMesh.scale.set(0.05, 0.05, 0.05);
                RhinoMesh.castShadow = true;
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('05.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('05.obj', function (group) {
                RhinoMesh = group.children[0];
                RhinoMesh.material.side = THREE.DoubleSide;
                RhinoMesh.scale.set(0.05, 0.05, 0.05);
                RhinoMesh.castShadow = true;
